...
export class AboutSectionComponent {
  ...
  projects:Array<string> =['DAZN Streaming Platform', 'Healthcare Application', 'Educational Application', 'E-commerce Application', 'Interview panel', 'Freelancing web-site', ]
  experience:number = 4
}
